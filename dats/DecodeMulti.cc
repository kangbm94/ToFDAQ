...
void DecodeMulti(string filename, TString outfile){
	FILE* fbin;
	...
	tree->Branch("qdc",qdc,"qdc[96]/I");
	tree->Branch("tdc",tdc,"tdc[96]/I");
...
void DecodeTime(string filename, TString outfile){
	...
	tree->Branch("et",&et,"et/I");//After Binary porcessing
