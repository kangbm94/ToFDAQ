/*!
        ...
        Output buffer structure and memory map of V792
				Modified: April 2021
...
// V792 Output Buffer bit field
// output buffer, ro, D16
typedef struct _V792_OUTBUF_REG{
    union {
        struct {
            uint32_t data         : 12;
            uint32_t overFlow     : 1;
...
class CAENVMEV792:public CAENVMEModule{
	public:
		CAENVMEV792(){
			name+="V792";
		};
